...
function installDependencias() {
  ...
  if [ "$opt1" == "y" ]; then
    ...
    sudo apt install -y dconf-cli libglib2.0-bin papirus-icon-theme mesa-opencl-icd ocl-icd-libopencl1 librsvg2-common shared-mime-info mesa-vulkan-drivers intel-media-va-driver adwaita-icon-theme libcanberra-gtk3-module xdg-desktop-portal xdg-desktop-portal-gtk gvfs gvfs-common thunar xclip xsel neovim zsh-syntax-highlighting bat lsd npm wmname libglib2.0-dev ripgrep unzip wget git curl xdg-user-dirs
